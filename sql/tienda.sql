...
INSERT INTO producto VALUES(7,'Monitor 27 LED Full HD',245,1,'../images/Gigabytet.jpeg','El monitor Full HD de LG basado en IPS ofrece una calidad de imagen precisa sin ningun tipo de distorsion y permite que los juegos sean lo mas realistas posible, aporta una experiencia de juego envolvente. Escenas de juego vivas y claras con FreeSync, el cual puedes jugar a juegos de alta gama sin la fragmentacion ni los cuadros interrumpidos que se producen a partir de la diferencia entre la velocidad de imagen de una tarjeta grafica y la frecuencia de actualizacion del monitor.');
